...
export default function FuturisticAI() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const savedApiKeys = localStorage.getItem("Anurag AI-api-keys");
      if (savedApiKeys) {
        try {
  ...
  const handleSaveApiKey = useCallback(() => {
    ...
    localStorage.setItem("Anurag AI-api-keys", JSON.stringify(updatedApiKeys));
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2 sm:space-x-3 flex-shrink-0">
                  ...
                  >
                    <a
                      href="https://github.com/Anurag113-sonu/Anurag-AI.git"
                      target="_blank"
                      rel="noopener noreferrer"
